            ...
            <div class="form-group row">
                <div class="col-sm-6 ">
                    <input readonly="readonly" type="text" class="form-control form-control-user" id="examplecodigo"
                        placeholder="Código de usuario" name = {this.props.codigodeusuario} ref={this.props.value_id}/>
                    <br />
                </div>
                <div class="col-sm-6 ">
                    <select class="form-control form-control-userselect" id="nivel" name = {this.props.niveldeusuario} ref={this.props.value_nivel}>
                ...
                <div class="col-sm-6 ">
                    <input type="text" class="form-control form-control-user" id="exampleNombres"
                        placeholder="Nombres" name = {this.props.nombres} ref={this.props.value_nombre}/>
                    <br />
                </div>

                <div class="col-sm-6 ">
                    <input type="text" class="form-control form-control-user" id="exampleApellidos"
                        placeholder="Apellidos" name = {this.props.apellidos} ref={this.props.value_apellido}/>
                    <br />
                </div>

                <div class="col-sm-6 ">
                    <select class="form-control form-control-userselect" id="gender" name = {this.props.gender} ref={this.props.value_gender}>
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user"
                        id="telefono" placeholder="Telefono" name = {this.props.telefono} ref={this.props.value_telefono}/>
                    <br/>
                </div>   
                
                <div class="col-sm-6">
                        <select class="form-control form-control-userselect" id="tipodocumento" name = {this.props.tipodocumento} ref={this.props.value_tipodoc}>
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user"
                        id="examplebarrio" placeholder="Número de Documento" name = {this.props.numerodocumento} ref={this.props.value_documento}/>
                    <br/>
                </div>  

                <div class="form-group">
                        <input type="email" class="form-control form-control-user" id="exampleemail"
                            placeholder="Correo Electronico" name = {this.props.email} ref={this.props.value_email}/>
                </div>
